        ...
        <div class="card m-2 p-2 bg-light">
          ...
          <ul class="nav nav-pills flex-column">
            ...
            <ul class="list-group">
              <NuxtLink
                ...
                class="list-group-item cursor-pointer hover-color bg-light border-0"
                :class="
                  $route.path.startsWith('/memes-contest') ? 'active' : ''
                "
                @click="closeLeftSidebar"
              >
                Memes contest
          ...
          -->
            ...
            >
              <NuxtLink
                class="nav-link"
                :class="
                  $route.path.startsWith('/notifications') ? 'active' : ''
                "
                aria-current="page"
                to="/notifications"
              >
            ...
            >
              <NuxtLink
                class="nav-link"
                :class="
                  $route.path.startsWith('/activity-points') ? 'active' : ''
                "
                aria-current="page"
                to="/activity-points"
              >
          ...
          -->
            ...
            <li
              ...
              @click="closeLeftSidebar"
              v-if="
                ($config.airdropClaimDomainsAddress ||
                  $config.airdropApAddress) &&
