<template>
  ...
  <div class="card border scroll-500">
    <div class="card-body">
      ...
      <p class="text-break mt-3">
        Scrolly Hub is a place where social networking is fully decentralized, permissionless and all the data is owned by users. 
      ...
      <p class="text-break mt-3">
        ...
        <a target="_blank" href="https://scrolly.xyz">Team Scrolly</a> & 
        <a target="_blank" href="https://iggy.social/">Team Iggy</a>.
      </p>

      <h5>Useful links</h5>

      <ul>
        <li><a href="https://github.com/ScrollyXYZ?tab=repositories" target="_blank">Scrolly GitHub</a></li>
        <li><a href="https://twitter.com/scrollyxyz" target="_blank">Scrolly Twitter</a></li>
        <li><a href="https://t.me/ScrollyTheMap" target="_blank">Telegram</a></li>
      </ul>
      ...
      <p class="text-break mt-3">
        Feel free to post ideas, features suggestions, rants directly in the Scrolly Hub chat. 
      </p>
